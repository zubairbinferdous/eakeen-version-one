                    ...
                    <div class="col-xxl-2 col-lg-3 col-sm-4 col-6">
                        <div
                            ...
                            <div class="mt-12">
                                ...
                                <span class="text-gray-900 text-xs fw-medium mt-8">coin: {{ $item->coin }}</span>
                            </div>
                            <div class="product-card__content mt-12">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="product-details.html" class="link text-line-2">{{ $item->product_title }}</a>
                                </h6>
        ...
        <div class="container container-lg">
            <div class="section-heading flex-between flex-wrap gap-16">
                ...
                <ul class="nav common-tab nav-pills" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-fruits-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-fruits" type="button" role="tab" aria-controls="pills-fruits"
                            aria-selected="false">Fruits</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-juices-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-juices" type="button" role="tab" aria-controls="pills-juices"
                    ...
                    <div class="row g-12">
                        ...
                        <div class="col-xxl-2 col-lg-3 col-sm-4 col-6">
                            <div
                                ...
                                <div class="product-card__content p-sm-2">
                                    <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                        <a href="product-details.html" class="link text-line-2">Nature Valley Whole Grain
