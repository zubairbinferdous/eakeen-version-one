            ...
            <div class="grid grid-cols-12 gap-x-6">
                <div class="col-span-12 lg:col-span-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form class="sm:grid grid-cols-12 gap-x-6 space-y-4 lg:space-y-0" method="POST"
                                action="{{ route('newAccount') }}">
                                ...
                                <div
                                    ...
                                    <input type="user" name="name" class="my-auto ti-form-input"
                                        placeholder="Account Name">
                                </div>
                                <div
                                    class="col-span-12 lg:col-span-4 sm:inline-flex sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full rtl:space-x-reverse">
                                    <!-- <label class="w-32 ti-form-label mb-0">Amount</label> -->
                                    <input type="text" name="openingBalance" class="ti-form-input"
                                        placeholder="Opening Balance">
                                </div>
                                <div
                                    class="col-span-12 lg:col-span-4 sm:inline-flex sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full rtl:space-x-reverse">
                                    <!-- <label class="w-32 ti-form-label mb-0">Amount</label> -->
                                    <input type="text" name="currentBalance" class="ti-form-input"
                                        placeholder="Current Balance">
                                </div>


                                <button type="submit"
                                    class="col-span-12 mt-4 lg:col-span-3 ti-btn ti-btn-primary">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
