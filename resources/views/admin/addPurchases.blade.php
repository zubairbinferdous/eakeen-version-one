                        ...
                        <div class="my-2 py-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h5 class="box-title">Create Purchase</h5>
                                </div>
                                <div class="box-body">
                                    <form class="sm:grid grid-cols-12 gap-x-6 space-y-4 lg:space-y-0">
                                        ...
                                        <div
                                            ...
                                            <input type="password" class="ti-form-input" placeholder=" Purchase Date">
                                        </div>
                                        <div
                                            class="col-span-12 lg:col-span-3 sm:inline-flex sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full rtl:space-x-reverse">
                                            <!-- <label class="w-32 ti-form-label mb-0"></label> -->
                                            <input type="email" class="my-auto ti-form-input" placeholder="Product Name">
                                        </div>
                                        ...
                                        <div class="box_10">
                                            <button type="submit"
                                                class="col-span-12 lg:col-span-5 ti-btn ti-btn-primary">Submite
                                            </button>
                                        </div>
                                    </form>
                                </div>
